...
void ling_control_center_load(LingControlCenter * self){
    ...
    ling_grid_attach_item(LING_GRID(self->grid),self->wlan_button,1,1,2,1);
    ...
    ling_grid_attach_item(LING_GRID(self->grid),self->ble_button,3,1,2,1);
    ...
    ling_grid_attach_item(LING_GRID(self->grid),self->media,1,2,2,2);
    ...
    ling_grid_attach_item(LING_GRID(self->grid),self->brightness,3,2,1,2);
    ...
    ling_grid_attach_item(LING_GRID(self->grid),self->volume,4,2,1,2);
    ...
    for(int i=0;i<2;i++){
        for(int j=1;j<=4;j++){
            ...
            ling_grid_attach_item(LING_GRID(self->grid),button,j,4+i,1,1);
        }
    }
}
