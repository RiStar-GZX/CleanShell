...
Currently, it is in the stage of interface development, and the development of the window manager will commence once the interface is largely completed.
目前处于界面开发阶段，等界面基本开发完毕就开始开发窗口管理器
